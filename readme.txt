...
__This plugin requires a <a href="http://www.emldesk.com/">EmlDesk</a> compatible account.__ <br>

EmlDesk Subscription Forms plugin allows you to embed EmlDesk compatible subscription forms directly into your WordPress powered website.  Embedding a subscription form in your website makes it easy for people to signup to receive your email marketing.
...
4. Drag the 'EmlDesk Subscription Form' widget to the sidebar.
5. Enter an API Token.  API Token can be generated from your EmlDesk compatible account.
